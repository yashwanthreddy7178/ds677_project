        ...
        return executor.submit(() -> {
            for (ObjectNode obj : batch) {
                try {
                    ...
                    String prompt = "Generate a clear, concise instruction for implementing this Java method. Follow these guidelines:\n" +
                        "1. Start with an action verb (implement, write, create, develop)\n" +
                        "2. Specify the function name and its purpose\n" +
                        "3. Mention key parameters and return type\n" +
                        "4. Include any important constraints or requirements\n" +
                        "5. Keep the instruction focused and specific\n\n" +
                        "Java method to analyze:\n" + code;
